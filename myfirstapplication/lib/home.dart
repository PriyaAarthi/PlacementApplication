...
import 'dart:convert';
import 'dart:html';
import 'package:myfirstapplication/placement_info.dart';
import 'package:myfirstapplication/student_data.dart';
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      final http.Response response = await http.post(
        Uri.parse('http://10.11.6.4:8000/addcompany'),
        headers: {
                    ...
                    itemBuilder: (_, index) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          setState(() {
                            selectedIndex = index;
                            _imageUrlController.text = pre[index].imageUrl;
                          });
                        },
                        child: Container(
                          decoration: BoxDecoration(
